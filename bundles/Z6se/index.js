...
},{"../common/html.js":128,"../tree-adapters/default.js":138,"entities/escape":145}],136:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../common/error-codes.js":126,"../common/html.js":128,"../common/token.js":129,"../common/unicode.js":130,"./preprocessor.js":137,"entities/decode":139}],137:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./dist/commonjs/decode.js":141}],140:[function(require,module,exports){
"use strict";
// Adapted from https://github.com/mathiasbynens/he/blob/36afe179392226cf1b6ccdb16ebbb7a5a844d93a/src/he.js#L106-L134
var _a;
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./decode-codepoint.js":140,"./generated/decode-data-html.js":143,"./generated/decode-data-xml.js":144}],142:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./dist/commonjs/escape.js":142}],146:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Z6se = exports.Z6seInfo = void 0;
const types_1 = require("@paperback/types");
const parser_1 = require("./parser");
const BASE_URL = "https://www.06se.com";
...
const TAG = "[Z6se]";
class Z6se extends types_1.Source {
    constructor() {
        super(...arguments);
        // ──────────────────────────────────────────────
        // RequestManager
            ...
            interceptor: {
                interceptRequest: async (request) => {
                    ...
                    if (isImage) {
                        ...
                        const match = request.url.match(/album\/\d+\/(\d+)\//i) ||
                    ...
                    request.headers = Object.assign(Object.assign({}, ((_a = request.headers) !== null && _a !== void 0 ? _a : {})), { "User-Agent": USER_AGENT, "Accept-Language": "zh-TW,zh-Hant;q=0.9", Referer: dynamicReferer, "Sec-Fetch-Dest": isImage ? "image" : "document", "Sec-Fetch-Mode": isImage ? "no-cors" : "navigate", "Sec-Fetch-Site": isImage ? "same-site" : "same-origin" });
                    ...
                    console.log(`${TAG} → ${request.method} ${request.url} | 動態 Referer: ${dynamicReferer}`);
                    return request;
                },
                interceptResponse: async (response) => {
                    ...
                    console.log(`${TAG} ← HTTP ${response.status} ` +
                        ...
                        `(${((_a = response.data) !== null && _a !== void 0 ? _a : "").length} bytes)`);
                    // 偵測是否被重導向到登入頁或錯誤頁
                    if (response.status !== 200) {
                        console.error(`${TAG} 非 200 狀態碼！data preview: ${((_b = response.data) !== null && _b !== void 0 ? _b : "").substring(0, 300)}`);
                    }
                    return response;
                },
            },
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
        ...
        try {
            ...
            console.log(`${TAG} getViewMoreItems: parsed ${items.length} items (page ${page})`);
    ...
    async getMangaDetails(mangaId) {
        ...
        try {
            ...
            console.log(`${TAG} getMangaDetails: title="${detail.title}" author="${detail.author}" tags=${detail.tags.length} images=${detail.images.length}`);
            if (detail.images.length === 0) {
                console.warn(`${TAG} getMangaDetails: 0 images — 檢查 parseAlbumDetail selector`);
                console.log(`${TAG} html preview: ${response.data.substring(0, 500)}`);
            }
            const tagGroups = detail.tags.length > 0
                ? [
            ...
            return App.createSourceManga({
                ...
                mangaInfo: App.createMangaInfo({
                    ...
                    desc: "",
                    status: "Completed",
                    author: (_a = detail.author) !== null && _a !== void 0 ? _a : "",
                    tags: tagGroups,
                }),
            });
        }
...
},{"./parser":147,"@paperback/types":61}],147:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
